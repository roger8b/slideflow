    ...
    return (
        <div
            ...
            style={{
                ...
                flexShrink: (isFixed || computedHeight === 'auto') ? 0 : 1,
                flexBasis: (isFixed || computedHeight === 'auto') && computedHeight !== 'auto' ? computedHeight : 'auto',
                height: computedHeight,
                minHeight: computedHeight === 'auto' ? (enabled && !children ? '100px' : '0') : computedHeight,
                width: '100%',
