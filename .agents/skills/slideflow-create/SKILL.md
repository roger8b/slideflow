...
```bash
python3 /path/to/.Codex/skills/slideflow-create/scripts/generate_presentation.py \
...
**To find the skill path:** look for `SKILL.md` in `.Codex/skills/slideflow-create/` relative to the project root, or search with `find ~ -path "*slideflow-create/scripts/generate_presentation.py" 2>/dev/null | head -1`.
